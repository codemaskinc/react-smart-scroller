...
export class ReactSmartScrollerHorizontal extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    get trackPadding() {
        ...
        return trackProps
            ? C.getPaddingValues(trackProps.padding, trackProps.paddingLeft, trackProps.paddingRight, trackProps.paddingTop, trackProps.paddingBottom) : {
            top: 0,
            right: 0,
            bottom: 0,
            left: 0
    ...
    onScrollbarClick({ clientX }) {
        const thumbRef = this.thumbRef.current;
        const overflowRef = this.overflowContainerRef.current;
        const shouldReturn = C.all(thumbRef, overflowRef, clientX >= (thumbRef.offsetLeft + overflowRef.getBoundingClientRect().left), clientX <= (thumbRef.offsetLeft + overflowRef.getBoundingClientRect().left + thumbRef.offsetWidth));
    ...
    renderThumb() {
        ...
        return (React.createElement(RectangleThumb, { ref: this.thumbRef, onMouseDown: this.onMouseDown, style: { width } }));
    }
    renderScrollbar() {
    ...
    renderPagination() {
        ...
        return (React.createElement(Pagination, { style: customStyles, ref: this.paginationRef },
    ...
    render() {
        ...
        return (React.createElement("div", { style: style },
            React.createElement(SecondWrapper, { ref: this.overflowContainerRef, onScroll: this.onOverflowContentScroll, onMouseDown: draggable ? this.onOverflowContentMouseDown : C.noop, style: { cursor } }, this.renderChildren()),
