...
import { ReactSmartScrollerVertical, RectangleThumb, Track, Content } from "./ReactSmartScrollerVertical";
...
describe('ReactSmartSliderVertical: lib/components', () => {
  it('should render itself', () => {
    const wrapper = shallow(React.createElement(ReactSmartScrollerVertical, initialProps));
  ...
  it('should invoke addEventListener', () => {
    ...
    shallow(React.createElement(ReactSmartScrollerVertical, initialProps));
  ...
  it('should set state after measureContainers invoked', () => {
    const wrapper = shallow(React.createElement(ReactSmartScrollerVertical, _extends({}, initialProps, {
      numCols: undefined
    })));
    ...
    const scrollOffset = scrollCircleTopOffset > documentHeight ? documentHeight - value : documentHeight;
  ...
  it('should set thumb critical dimensions after mouseDrag', () => {
    ...
    const criticalScrollerDimensions = offset > 0 ? 1500 - state.scrollContainerHeight : 0;
    wrapper.setState(state);
    getRefCurrent(overflownRef, {
      scroll: jest.fn(),
      getBoundingClientRect: jest.fn(() => ({
  ...
  it('should render custom thumb if provided', () => {
    ...
    shallow(React.createElement(ReactSmartScrollerVertical, _extends({}, initialProps, {
      numCols: undefined,
  ...
  it('should remove mousemove event', () => {
    window.removeEventListener = jest.fn();
    const wrapper = shallow(React.createElement(ReactSmartScrollerVertical, null));
    const wrapperInstance = wrapper.instance();
